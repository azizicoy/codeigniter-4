    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card mb-4 shadow">
                ...
                <form class="card-body" action="/program/pegawai/save" method="POST">
                    <?= csrf_field(); ?>
                    <!-- Input Nama -->
                    <div class="form-group row mb-2">
                        ...
                        <div class="col">
                            <input type="text"
                                ...
                                value="<?= old('kode_pegawai');?>" id="kode_pegawai" name="kode_pegawai"
                                placeholder="ATU1234567" autocomplete="off" autofocus>
                            <!-- error -->
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col">
                            <input type="text"
                                ...
                                value="<?= old('nama_pegawai');?>" id="nama_pegawai" name="nama_pegawai"
                                placeholder="Jaka Sembung" autocomplete="off" autofocus>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col">
                            <input type="email" id="e_mail_pegawai" name="e_mail_pegawai"
                                ...
                                value="<?= old('e_mail_pegawai');?>" autocomplete="off" placeholder="emai@gmail.com">
                            <!-- error -->
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col">
                            <input type="tel" id="no_telp_pegawai" name="no_telp_pegawai"
                                ...
                                value="<?= old('no_telp_pegawai');?>" autocomplete="off" placeholder="089966371231">
                            <!-- error -->
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col">
                            <textarea
                                ...
                                placeholder="Jl. Mega Mendung 1"><?= old('alamat_pegawai');?></textarea>
                            <!-- error -->
                            <div id="validationServer03Feedback" class="invalid-feedback">
