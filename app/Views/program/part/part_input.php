...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active"><a href="/part">Part</a></li>
        <li class="breadcrumb-item active">Form Input Part</li>
    </ol>
    <div class="row">
            ...
            <div class="card mb-4 shadow">
                <div class="card-header">
                    <h5 class="text-center">
                        Input Data Spare Part
                    </h5>
                </div>
                <?= helper('form'); ?>
                <form class="card-body" action="/program/part/save" method="POST">
                    <?= csrf_field(); ?>
                    <!-- Input Nama Part -->
                    <div class="form-group row mb-2">
                        ...
                        <div class="col">
                            <input type="text"
                                ...
                                value="<?= old('nama_part');?>" id="nama_part" name="nama_part" autocomplete="off"
                                autofocus>
                            <!-- error -->
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col">
                            <input type="text" id="satuan" name="satuan"
                                ...
                                value="<?= old('satuan');?>" autocomplete="off">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col">
                            <input type="number" id="jumlah_part" name="jumlah_part"
                                ...
                                value="<?= old('jumlah_part');?>" autocomplete="off">
